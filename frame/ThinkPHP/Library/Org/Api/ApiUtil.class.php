...
class ApiUtil {
    ...
    public function encryptMsg($replyMsg, $timeStamp, $nonce, &$encryptMsg) {
        $pc = new \Org\Api\Prpcrypt($this->EncodingAESKey);
    ...
    public function decryptMsg($msgSignature, $timestamp = null, $nonce, $encrypt, &$msg) {
        if (strlen($this->EncodingAESKey) != 43) {
            return \Org\Api\ErrorCode::$IllegalAesKey;
        }
        ...
        if ($signature != $msgSignature) {
            return \Org\Api\ErrorCode::$ValidateSignatureError;
        }
