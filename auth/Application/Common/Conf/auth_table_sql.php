...
"CREATE TABLE `" . C('TB_APP_VERSION') . "` (
  ...
  PRIMARY KEY (`id`)
    ...
    'TB_AUTH_FUNCTION_SQL' =>
"CREATE TABLE `" . C('TB_AUTH_FUNCTION') . "` (
    ...
    'TB_AUTH_FUNCTION_GROUP_SQL' =>
"CREATE TABLE `" . C('TB_AUTH_FUNCTION_GROUP') . "` (
...
"CREATE TABLE `" . C('TB_AUTH_USER') . "` (
    ...
    'TB_AUTH_USER_GROUP_SQL' =>
"CREATE TABLE `" . C('TB_AUTH_USER_GROUP') . "` (
    ...
    'TB_AUTH_USER_USERGROUP_SQL' =>
"CREATE TABLE `" . C('TB_AUTH_USER_USERGROUP') . "` (
	`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '记录id',
    ...
    'TB_AUTH_USERGROUP_FUNCTION_SQL' =>
"CREATE TABLE `" . C('TB_AUTH_USERGROUP_FUNCTION') . "` (
	`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '记录id',
	`user_group_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户组ID',
    ...
    'TB_AUTH_USER_FUNCTION_SQL' =>
"CREATE TABLE `" . C('TB_AUTH_USER_FUNCTION') . "` (
	`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '记录id',
	`user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户id',
    ...
    'TB_AUTH_USER_APP_SQL' =>
"CREATE TABLE `" . C('TB_AUTH_USER_APP') . "` (
	`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '记录id',
    ...
    'TB_AUTH_DEPARTMENT_SQL' =>
"CREATE TABLE `" . C('TB_AUTH_DEPARTMENT') . "` (
    ...
    'TB_AUTH_POSITION_SQL' =>
"CREATE TABLE `" . C('TB_AUTH_POSITION') . "` (
	`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '记录id',
...
"CREATE TABLE `" . C('TB_AUTH_MENU') . "` (
    ...
    'TB_LOG_AUTH_LOGIN_SQL' =>
"CREATE TABLE `" . C('TB_LOG_AUTH_LOGIN') . "` (
	`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '记录id',
    ...
    'TB_LOG_AUTH_ACCESS_SQL' =>
"CREATE TABLE `" . C('TB_LOG_AUTH_ACCESS') . "` (
	`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '记录id',
	`app_id` varchar(64) NOT NULL DEFAULT '' COMMENT '应用id',
